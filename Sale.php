...
if (isset($_POST['btnsubmit'])) {
    ...
    $stmt = $connection->prepare("SELECT * FROM product WHERE Barcode = ?");
...
<body>
   <div class="Navbar">
    ...
    <form action="Sale.php" method="POST">
        <h2 style="color: red;">လက်လီ အရောင်း</h2>
        <div class="sale-div">
    ...
    <div class="ongoing-sale">
        <?php    
        $select = "SELECT s.*, p.Product_Name, p.Sell_Price FROM Sale s JOIN product p ON s.Product_ID = p.Barcode WHERE s.Status = '0'";
            ...
            <table>
                ...
                ?>
                    <tr class="item">
                        ...
                        <td><a class="cancel" href="Sale_Cancel_P.php?PID=<?php echo $purchaseid ?>">Cancel</a></td>
                    </tr>
                <?php 
                }
                ?>
